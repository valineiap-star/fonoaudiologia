  ...
  return (
    <section className="relative pt-10 sm:pt-16 md:pt-20 pb-12 sm:pb-16 overflow-hidden bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center space-y-8">
        ...
        {/* Hero Mockup with 100% Transparent Background & Smooth Looping Animation */}
        <div className="w-full max-w-2xl mx-auto my-2 flex items-center justify-center relative">
          <div className="absolute inset-0 bg-teal-200/25 rounded-full blur-3xl -z-10 transform scale-90 animate-pulse-subtle" />
          <img
            src="/hero-mockup-custom.png"
            alt="Materiais Fonoaudiologia Visual - Mockup Digital Completo"
            referrerPolicy="no-referrer"
            className="w-full h-auto max-h-[520px] object-contain drop-shadow-xl select-none animate-float-loop transition-transform duration-300 hover:scale-[1.02]"
          />
        </div>
